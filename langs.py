...
leninfospalte=24 # length of app column
...
splitbefore = '„‚([{<$~^€£¥±©®™§†‡“”‘«¿¡' # "
# no_split = {
#     'de': ["sch", "ch", "ck", "tz", "pf", "qu", "st", "sp", "ei", "ai", "eu", "äu", "au", "ie"],
#     'en': ["th", "sh", "ph", "wh", "qu", "ck", "tr", "dr", "ea", "ee", "oo", "oa", "ai", "ei", "ou", "ow", "oy", "ay"],
#     'es': ["ll", "rr", "ch", "qu", "ia", "ie", "io", "iu", "ua", "ue", "uo", "ui", "ei", "oi"],
#     'fr': ["ch", "gn", "ph", "qu", "ai", "ei", "oi", "ui", "ou", "eu", "au", "oe"]
# }
no_split = {
    'de': [
        "sch", "ch", "ck", "tz", "pf", "qu", "sp", "st",
        "ei", "ie", "au", "eu", "äu", "aa", "ee", "oo", "ue", "ui", "ai",
    ],
    'en': [
        "th", "sh", "ph", "wh", "qu", "ck", "tr", "dr", "br", "cr", "gr", "fr", "pr", "bl", "cl", "gl", "pl", "sl", "sc", "sk", "sp", "st", "sw",
        "oo", "ee", "ea", "ou", "ie", "ei", "ai", "au", "oa", "ue",
    ],
    'es': [
        "ll", "rr", "ch", "qu", "gu",  # gu -> wie in "guitarra"
        "ie", "ei", "ue", "ua", "io", "oi", "ia", "ai",
    ],
    'fr': [
        "ch", "gn", "ph", "qu", "gu", "ill",  # "gu" in guerre, "ill" wie in "fille"
