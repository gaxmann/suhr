...
### Changed
- Temporal hours are now counted from 0.0 to 11.9. *After closer historical review, this has proven to be the more consistent and logical system. The problem was that “we meet at the sixth hour” actually meant meeting at the beginning of the 7th one, because the hour was not announced until its completion. With the new counting, the sixth hour now begins at 5.1 and will be announced at 6.0. A meeting at the sixth hour therefore correctly takes place at 6.0. - This counting logic still exists in German dialects: ”half two” means 13:30, and “three quarters two” means 13:45, both referencing the approach toward completion of the next hour*
