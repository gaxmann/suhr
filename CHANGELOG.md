# Changelog
This is the detailed changelog. All notable changes to this project will be documented in this file (tags: Added, Changed, Deprecated, Removed, Fixed, Security). A detailed changelog is available below. [Here](./WHATSNEW.md) you'll find a short summary of the latest changes.
