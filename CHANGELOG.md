...
## [2.63] - 2025-11-xx (Temporal update)

### Changed
- *After extensive research and discussions, the way temporal hours are counted has now been changed to 0.0-11.9. This is logical and consistent for the 21st century: the sixth hour begins at 5.01, but is not announced until 6.0 (to mark its completion). A meeting at the sixth hour therefore correctly takes place at "6.0". This old counting system still exists in German dialect: "half two" sic(!) is 13:30, "three quarters two" is 13:45 (aligned with completion)*
