# Changelog
All notable changes to this project will be documented in this file (tags: Added, Changed, Deprecated, Removed, Fixed, Security). [Here](./WHATSNEW.md) you'll find a short summary of the latest changes.
...
### Changed
- Special build (not for Play Store) for API 21 (Android 5) due to the unavoidable, upcoming minimum Android 7 requirement 
