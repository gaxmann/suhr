...
* with automatic updates from: [Google Play Store](https://play.google.com/store/apps/details?id=de.ax12.zunclock), Aurora, ...
* without from: [Github](https://github.com/gaxmann/suhr/releases/tag/v2.xxx) (with additional apk for older devices) or Apkpure, ... 
