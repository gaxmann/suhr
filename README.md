...
* with automatic updates from: [Google Play store](https://play.google.com/store/apps/details?id=de.ax12.zunclock), Aurora store, ...
* without automatic updates from: [Github](https://github.com/gaxmann/suhr/releases/tag/v2.xxx) or [Apkpure](https://apkpure.com/de/gordon%E2%80%99s-sun-clock/de.ax12.zunclock), ... 
