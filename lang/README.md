...
Sun Clock has fully supported languages (all entries translated) and **partially supported languages** (only about half of the entries translated). Partially supported languages include all entries up to `"txlegende"`, which marks the end of the translated section. You can distinguish them by filesize. 
